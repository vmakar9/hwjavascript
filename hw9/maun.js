...
/*let target = document.getElementsByClassName('all')[0];
for (const targetElement of simpsons) {
    let div = document.createElement('div');
    div.classList.add("members");
    target.appendChild(div);
    let memberTitle = document.createElement('h2');
    memberTitle.innerText = targetElement.name + " " + targetElement.surname + " " + targetElement.age;
    div.appendChild(memberTitle);
    let image = document.createElement('img');
    image.src = targetElement.photo;
    div.appendChild(image);
    let info = document.createElement('p');
    info.innerText = targetElement.info;
...
/*let target = document.getElementsByClassName("all")[0];
for (const targetElement of coursesArray) {
    let div = document.createElement("div");
    div.classList.add("title");
    target.appendChild(div);
    let titl = document.createElement("h1");
    titl.innerText = targetElement.title;
    div.appendChild(titl);

    let div2 = document.createElement("div");
    div2.classList.add("duration");
    target.appendChild(div2);
    let mdurat = document.createElement("h3");
    mdurat.innerText ="month duration: "+targetElement.monthDuration;
    div2.appendChild(mdurat);

    let div3 = document.createElement("div");
    div3.classList.add("hourduration");
    target.appendChild(div3);
    let hdurat = document.createElement("h3");
    hdurat.innerText ="hour durtation: "+targetElement.hourDuration;
    div3.appendChild(hdurat);

    let div4 = document.createElement("div");
    div4.classList.add("dur");
    div4.append(div2,div3);
    target.appendChild(div4);

    let modulesElement = document.createElement('ul');

    for (const moduleItem of targetElement.modules) {
        let module = document.createElement('li');
        module.innerText = moduleItem;
        modulesElement.appendChild(module);
    }
    target.appendChild(modulesElement);
}*/
...
for (const mElement of arr) {
    let li = document.createElement('li');
    li.innerText = mElement;
    m.appendChild(li);
}*/
...
let a = document.getElementsByClassName('all')[0];
for (const aElement of coursesAndDurationArray) {
    let div = document.createElement('div');
    div.innerText = aElement.title + " " + "month duration: "+ aElement.monthDuration;
    a.appendChild(div);
}*/
...
for (const xE of coursesAndDurationArray) {
    let div = document.createElement('div');
    ...
    h.innerText = xE.title;
    x.appendChild(h);
    p.innerText = "month duration: "+xE.monthDuration;
    x.appendChild(p);
}*/
